...
def setup_logger(name, save_dir, distributed_rank, is_train=True):
    ...
    if save_dir:
        prefix = 'train_' if is_train else 'inference_'
        filename = prefix + time.strftime("%Y-%m-%d_%H.%M.%S", time.localtime()) + ".log"
